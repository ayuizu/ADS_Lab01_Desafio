...
public class Produto
{
   ...
   //Métodos setter e getter
    ...
    //Métodos de acesso - dataValidade
    ...
    public boolean estaVencido(Data data){
        if((data.getAno()*365+data.getMes()*30+data.getDia())>(this.dataValidade.getAno()*365+this.dataValidade.getMes()*30+this.dataValidade.getDia())){
            System.out.println("Em " + data.toString()+" o produto está vencido.");
            return true;
        }else{
            System.out.println("Em " + data.toString()+" o produto NÃO está vencido.");
            return false;
        }
    }
    //Testando toString
